...
|---------|-------|--------|-----------|--------|
| 1 | Фаза 1: Shared Diagnostics | Высокий — убирает 10x подписок | Средняя | **DONE** |
| 2 | Фаза 2: Shared Node Status | Высокий — убирает N polling loops | Средняя | **DONE** |
| 3 | Фаза 4: Agent Reconnect | Высокий — 60s→5s восстановление | Средняя | **DONE** |
| 4 | Фаза 3: Shared Hz-Single | Средний — редко используется | Низкая | **DONE** |
| 5 | Фаза 5: Оптимизации broadcast | Низкий — микрооптимизации | Низкая | **DONE** |
| 6 | Фаза 6: Frontend reconnect | Средний — UX при обрывах | Низкая | **DONE** |
