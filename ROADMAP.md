...
### Dashboard Grid
- [ ] Подписка на /diagnostics топик (через exec_stream)
- [ ] Парсинг DiagnosticArray сообщений
- [ ] Карточки-плитки по компонентам
- [ ] Статус-индикатор: OK (green) / WARN (yellow) / ERROR (red) / STALE (gray)
- [ ] Ключевая метрика на карточке (частота, температура и т.д.)
- [ ] Фильтр по статусу и поиск
- [ ] Клик по карточке → детальный вид с историей key-value пар
...
## 🚧 v0.4 — Улучшения управления нодами
